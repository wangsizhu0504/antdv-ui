...
import { PropTypes, filterEmpty, functionType, stringType } from '../../_utils/vue'
import { classNames, cloneElement } from '../../_utils/dom'
import Step from './Step'
import type { StepRenderProps } from './props'
...
export default defineComponent({
  ...
  setup(props, { slots, emit }) {
    ...
    const renderStep = (item: StepRenderProps, index: number, legacyRender?: any) => {
      const {
        prefixCls,
        iconPrefix,
        status,
