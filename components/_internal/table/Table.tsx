...
import { getTargetScrollBarSize } from '../../_utils/scroll'
...
export default defineComponent<TableProps<DefaultRecordType>>({
  ...
  setup(props, { attrs, slots, emit }) {
    ...
    if (
      ...
      warningFn(false, '`expandedRowRender` should not use with nested Table')
    ...
    return () => {
      ...
      if (
        ...
        warningFn(false, '`components.body` with render props is only work on `scroll.y`.')
