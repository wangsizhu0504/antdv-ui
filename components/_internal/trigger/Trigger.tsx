...
import { addEventListenerWrap, classNames, cloneElement, contains } from '../../_utils/dom'
  ...
  methods: {
    ...
    getRootDomNode() {
      ...
      if (getTriggerDOMNode) {
        const domNode = this.triggerRef?.$el?.nodeName === '#comment' ? null : findDOMNode(this.triggerRef)
