...
import { Comment, Fragment, Text, h, isVNode } from 'vue'
...
const splitAttrs = (attrs: Recordable) => {
...
const hasProp = (instance: Recordable, prop: any) => {
  return instance[prop] !== undefined
}
// 重构后直接使用 hasProp 替换
const slotHasProp = (slot: Recordable, prop: any) => {
