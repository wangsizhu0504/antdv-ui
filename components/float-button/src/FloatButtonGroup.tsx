import { Transition, computed, defineComponent, onBeforeUnmount, ref, watch } from 'vue'
import { CloseOutlined, FileTextOutlined } from '@ant-design/icons-vue'
import { canUseDom, classNames } from '../../_utils/dom'
import { getTransitionProps } from '../../_internal/transition'
import { useConfigInject, useMergedState } from '../../hooks'
import { findDOMNode, initDefaultProps } from '../../_utils/vue'
