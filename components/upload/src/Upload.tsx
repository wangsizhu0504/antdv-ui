...
import { flattenChildren, initDefaultProps } from '../../_utils/vue'
...
import { file2Obj, getFileItem, removeFileItem, updateFileList } from './utils/utils'
...
import type { UploadRenderProps } from './props'
...
export default defineComponent({
  ...
  setup(props, { slots, attrs, expose }) {
    ...
    const onBatchStart: UploadRenderProps['onBatchStart'] = (batchFileInfoList) => {
    ...
    return () => {
      ...
      const renderUploadButton = (uploadButtonStyle?: CSSProperties) => (
        <div class={uploadButtonCls} style={uploadButtonStyle}>
          <UploadRender {...rcUploadProps} ref={upload} v-slots={slots} />
        </div>
      )
