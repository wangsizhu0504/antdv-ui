...
export const splitAttrs = (attrs: Recordable) => {
...
export const parseStyleText = (cssText = '', camel: boolean) => {
...
export const hasProp = (instance: Recordable, prop: any) => {
  return instance[prop] !== undefined
}
// 重构后直接使用 hasProp 替换
export const slotHasProp = (slot: Recordable, prop: any) => {
