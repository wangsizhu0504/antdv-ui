...
import LOCALE from '../locale/lang/zh_CN'
import { isObject } from '../_util/is'
import PropTypes from '../_util/vue-types'
import BaseMixin from '../_util/BaseMixin'
import { getComponent, hasProp, isValidElement, splitAttrs } from '../_util/props-util'
...
export default defineComponent({
  ...
  render() {
    ...
    let lastPager = null
    let gotoButton = null
    const goButton = isObject(showQuickJumper) && showQuickJumper.goButton
