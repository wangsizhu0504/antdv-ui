...
您可以使用 [主题定制](/docs/vue/customize-theme-cn) 修改 `screen[XS|SM|MD|LG|XL|XXL]` 来修改断点值（自 4.0.0 起，[codesandbox demo](https://codesandbox.io/s/usebreakpoint-hook-@antdv/ui-4-0-0-beta-4-forked-n2k1sy?file=/src/demo.vue)）。
