    ...
    <a-col flex="auto">
      <a-space direction="vertical" style="width: 100%" :size="0">
        ...
        <SplitSpace style="background: rgb(190, 200, 200)">
          ...
          <a-button type="dashed" ghost danger>
            Dashed
          </a-button>
        </SplitSpace>
        ...
        <!-- Steps -->
        <a-steps :current="1" :percent="60" :items="stepsItems" />

        <!-- Steps - dot -->
        <a-steps :current="2" status="error" progress-dot :items="stepsItems2" />
        ...
        <SplitSpace>
          ...
          <a-radio-group default-value="bamboo">
            <a-radio value="bamboo">
              Bamboo
            </a-radio>
            <a-radio value="light">
              Light
            </a-radio>
            <a-radio value="little">
              Little
            </a-radio>
          </a-radio-group>

          <a-mentions placeholder="Mention by @" :options="options" />
...
import { ConfigProvider, Divider, Space } from '@antdv/ui'
