import { camelize, filterEmpty, warningFn } from '@antdv/utils'
  ...
  function dig(treeNodes: any[] = []): DataNode[] {
    return filterEmpty(treeNodes).map((treeNode) => {
      ...
      if (!isTreeSelectNode(treeNode)) {
        warningFn(!treeNode, 'TreeSelect/TreeSelectNode can only accept TreeSelectNode as children.')
        return null
      }
...
export function fillAdditionalInfo(
  ...
  Object.defineProperty(extra, 'triggerNode', {
    get() {
      warningFn(false, '`triggerNode` is deprecated. Please consider decoupling data with node.')
      generateMap()
  ...
  Object.defineProperty(extra, 'allCheckedNodes', {
    get() {
      warningFn(false, '`allCheckedNodes` is deprecated. Please consider decoupling data with node.')
      generateMap()
