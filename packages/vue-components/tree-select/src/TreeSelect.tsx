...
import { PropTypes, initDefaultProps, omit, warningFn } from '@antdv/utils'
import type { Key, VueNode } from '@antdv/types'
import type { ExtractPropTypes, PropType } from 'vue'
import { useId, useMergedState } from '@antdv/hooks'
import { VcBaseSelect } from '../../select'
...
import type { ExpandAction } from '../../tree/src/props'
    ...
    const onInternalDropdownVisibleChange = (open: boolean) => {
      if (props.onDropdownVisibleChange) {
        ...
        Object.defineProperty(legacyParam, 'documentClickClose', {
          get() {
            warningFn(false, 'Second param of `onDropdownVisibleChange` has been removed.')
            return false
          },
        });
