...
import { classNames, eagerComputed, pickAttrs, warningFn } from '@antdv/utils'
...
export default defineComponent({
  ...
  setup(props, { attrs, slots, expose }) {
    ...
    const syncLoadData = () => {
      ...
      if (loadData && expanded.value && !getIsLeaf.value) {
    ...
    const renderDropIndicator = () => {
      ...
      const showIndicator = !disabled && rootDraggable && context.value.dragOverNodeKey === eventKey
      return showIndicator
        ? dropIndicatorRender({
          dropPosition: context.value.dropPosition,
          dropLevelOffset,
          indent,
          prefixCls,
          direction,
