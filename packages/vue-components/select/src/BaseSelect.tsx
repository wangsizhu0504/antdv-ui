...
import useInjectLegacySelectContext from '../../tree-select/src/LegacyContext'

import type { AlignType } from '../../trigger/src/interface'
import type { ScrollConfig, ScrollTo } from '../../virtual-list/src/List'
...
export default defineComponent({
  ...
  setup(props, { attrs, expose, slots }) {
    ...
    return () => {
      ...
      // Used for customize replacement for `inner-cascader`
