...
import type { ComponentToken as CascaderComponentToken } from '@antdv/components/cascader/style';
import type { ComponentToken as CheckboxComponentToken } from '@antdv/components/checkbox/style';
...
import type { ComponentToken as ListComponentToken } from '@antdv/components/list/style';
import type { ComponentToken as MentionsComponentToken } from '@antdv/components/mentions/style';
import type { ComponentToken as MenuComponentToken } from '@antdv/components/menu/style';
import type { ComponentToken as MessageComponentToken } from '@antdv/components/message/style';
import type { ComponentToken as ModalComponentToken } from '@antdv/components/modal/style';
import type { ComponentToken as NotificationComponentToken } from '@antdv/components/notification/style';
...
import type { ComponentToken as SegmentedComponentToken } from '@antdv/components/segmented/style';
import type { ComponentToken as SelectComponentToken } from '@antdv/components/select/style';
import type { ComponentToken as SkeletonComponentToken } from '@antdv/components/skeleton/style';
import type { ComponentToken as SliderComponentToken } from '@antdv/components/slider/style';
import type { ComponentToken as SpaceComponentToken } from '@antdv/components/space/style';
import type { ComponentToken as SpinComponentToken } from '@antdv/components/spin/style';
import type { ComponentToken as StepsComponentToken } from '@antdv/components/steps/style';
import type { ComponentToken as TableComponentToken } from '@antdv/components/table/style';
import type { ComponentToken as TabsComponentToken } from '@antdv/components/tabs/style';
